...
```{r, eval = FALSE}
library(remotes)
install_github("timriffe/coddecomp")
```

In this package, everything is a fucntion of rates (yay!), because recall, the three lifetable columns used in the Arriaga method can each be derived from rates, voila:
```{r}
library(coddecomp)
directional <-
  LT |> 
